...
parser.add_argument("--option", type=str, choices=['abc', 'deepcad', 'furniture','CADNet50'], default='abc', 
...
if args.option == 'deepcad': 
    ...
    OUTPUT = f'cadnet40v2_data_split_{args.bit}bit.pkl'
else:
    OUTPUT = f'furniture_data_split_{args.bit}bit.pkl'

# Load all STEP folders
if args.option in ['furniture','CADNet50']:
