...
#     --option surface --gpu 1 --env furniture_vae_surf --train_nepoch 200 --finetune \
#     --weight checkpoints/furniture_vae_surf.pt
...
#     --weight checkpoints/furniture_vae_edge.pt


python vae.py --data data_process/cadnet40v2_parsed \
    --train_list data_process/cadnet40v2_data_split_6bit_edge.pkl \
    --val_list data_process/cadnet40v2_data_split_6bit.pkl \
    --option edge --gpu 3 --env cadnet50_vae_edge --train_nepoch 200 --finetune \
    --weight checkpoints/abc_vae_edge.pt